...
model_cfg = {
    ...
    'pretrained_path': "/home/zf/.torch/models/densenet121-a639ec97.pth"
}
...
class DenseASPP(nn.Module):
    ...
    * output_scale can only set as 8 or 16
    ...
    def __init__(self, model_cfg,in_channels, n_class=19, output_stride=8):
        ...
        trans = _Transition(num_input_features=num_features, num_output_features=num_features , stride=1)
    ...
    def forward(self, _input):
        ...
        aspp3 = self.ASPP_3(feature) #(b,64,64,64)
